    ...
    <div id="app">
        ...
        <main class=" container py-4">
            <div class="row">
                <div class="col-md-4">
                    @auth
                    <a href="{{ route('discussions.create') }}" style="width: 100%;" class="btn btn-info my-3">Add Discussion</a>
                    @else
                    <a href="{{ route('login') }}" style="width: 100%;" class="btn btn-info my-3">Sign in to Add Duscussion</a>
                    @endauth
                    <div class="card">
